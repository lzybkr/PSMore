...
namespace PSMore.Formatting
{
    internal class FormatBinder : CallSiteBinder
    {
        ...
        static readonly MethodInfo FormatLineMethodInfo =
            typeof(RuntimeHelpers).GetMethod(nameof(RuntimeHelpers.FormatLine), BindingFlags.NonPublic | BindingFlags.Static);
